            ...
            <div class="row">
                ...
                <div class="card col-11">
                    ...
                    <div class="subscription-section">
                        ...
                        <form method="POST" id="form" action="{{ route('transact') }}">
                            ...
                            <div class="list-group">
                                <input type="radio" name="amount" value="500" id="monthly" />
                                <label class="list-group-item" for="monthly">
                                    <b> 7 Days Access - 30% off</b>
                                    <p class="mx-4">
                                ...
                                <input checked type="radio" name="amount" value="1500" id="weekly" />
                                ...
                                <input type="radio" name="amount" value="300" id="daily" />
                                <label class="list-group-item" for="daily">
                                    <b> 3 Days Trial Access - 50% off</b>
                                    <p class="mx-4">
                                        Browse profiles of hot singles unlimited for 3 days
                                    </p>
                                    <div class="select-price">
                                        Kshs.<strong>150</strong>
                                    </div>
                                </label>
                            </div>
                    </div>
                    <div class="form-section">
                        <div class="row m-2">
                            <div class="mb-3">
                                <label for="InputNumber" class="form-label">Mpesa Number</label>
                                <input type="phone" name="phone" class="form-control" id="InputNumber1"
                                    placeholder="e.g 0700 123 456" required />
                            </div>
                        </div>
