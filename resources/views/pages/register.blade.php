...
@section('content')
    <div class="container fluid">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-8 col-8 col-md-6 mx-auto">
                        <div class="form">
                            ...
                            <!-- Step-1 -->
                            <div class="step-text text-center fw-bold py-2">Step 1: <span
                                    class="text-secondary fw-normal">What are you
                                    looking
                                    for</span>
                            </div>
                        ...
                        <div class="form2 d-none">
                            ...
                            <!-- Step-2 -->
                            <div class="step-text text-center fw-bold py-2">Step 2: <span
                                    class="text-secondary fw-normal">What is your
                                    age</span>
                            </div>
                            <input id="age" type="number" placeholder="Age" name="age" class="select-box"
                                required autocomplete="age">

                            <span id="agecheck" class="agecheck d-none"role="alert">
                                <p class="text-danger">**Sorry, age not allowed</p>
                            </span>
                        ...
                        <div class="form3 d-none">
                            ...
                            <!-- Step-3 -->
                            <div class="step-text text-center fw-bold py-2">Step 3: <span
                                    class="text-secondary fw-normal">Where are you
                                </span>
                            </div>

                            <!-- Autocomplete location search input -->
                            <label class="ms-4 py-2">Estate/Town/City</label>
                            <input type="text" id="search_input" class="select-box" id="location" name="location"
                        ...
                        <div class="form4 d-none">
                            ...
                            <!-- Step-4 -->
                            <div class="step-text text-center fw-bold py-2">Step 4: <span
                                    class="text-secondary fw-normal">Email
                                    Address</span>
                            </div>
                            ...
                            <input id="email" type="email" placeholder="Email:" name="email"
                                class="select-box form-control input-w" autocomplete="email">
                        ...
                        <div class="form5 d-none">
                            ...
                            <!-- Step-1 -->
                            <div class="step-text text-center fw-bold py-2">Step 5: <span
                                    class="text-secondary fw-normal">Create your
                                    username and password</span>
                            </div>
                            <label class="ms-4 my-2">User name:</label>
                            <input id="name" type="text" placeholder="name" name="name"
                                value="{{ old('name') }}" class="select-box mb-2 form-control input-w" required
                                autocomplete="name">
                            ...
                            <input id="password" placeholder="password" type="Password" name="password"
                                class="select-box" required autocomplete="new-password">
                            ...
                            <input id="password_confirmation" type="Password" placeholder="password confirmation"
                                name="password_confirmation" class="select-box" required autocomplete="new-password">
                            <div class="row px-4">
                                <button type="submit"
                                    class="next-btn btn btn-primary mt-4 px-5 py-2 rounded-pill">FINALIZE ACCOUNT</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Sign in -->
        <p class="text-center text-secondary m-4">Already a member?<a href="#" id="sign-anchor"
                    ...
                    <h4 class="text-center fw-bold mb-5">Log in</h2>
                        ...
                        <div class=" signin-content">
                            ...
                            <div class="joinNow d-flex flex flex-direction-row justify-content-between px-3 py-2">
                                ...
                                <a href="#" class="link-anchor text-center"
                                    onclick="onforgotPasswordClick()">Forgot Password?</a>
                            </div>
                            <div class="row px-4">
                                <button type="button" class="next-btn btn btn-primary mt-4 px-5 py-2 rounded-pill"
                        ...
                        <div class="forgotPasswordContent d-none">
                            <h6 class="text-secondary px-5 text-center pb-4">Enter your email address and we will send you
                                further
                                instructions</h6>
                            <div class="emailBox row px-4 py-2">
                                <input type="email" placeholder="Email" class="text-center">
        ...
        <section>
            <div class="container-lg my-5">
                <!-- Heading Row -->
                <div class="row">
                    <h2 class="fw-bold text-center my-3">LuckyMate Is The Hottest Singles Site Around Right Now!</h2>
                    <p class="text-secondary">LuckyMate is a singles site where finding someone to go on a date with has
                        been
                        made easier than you could
                        ever ask it to be! Quite simply, for Kenyan men and women there is no better dating site around
                        right now
                        for you to be able to find that kind of date that you have always dreamt of having. Our singles site
                        might
                        not be all about romance or love, but if you are looking for an encounter that is hot and exciting
                        and that
                        you will never forget then our site is exactly what you have been looking for. Your search for the
                        ideal
                        online dating service just ended the moment you set foot on our site.</p>

                    <p class="text-secondary">We are so confident that you will find the right person or people for you
                        quite
                        simply because our other
                        members regularly tell us just how much of a difference luckymate.co.ke has made to their dating
                        lives. It
                        has worked for them and we know that it will work for you as well. If you have never been a member
                        of a
                        singles site before then it will take you almost no time at all in getting used to how it all works
                        because
                        it really is far easier than you might expect. Just fill in your profile, start browsing through the
                        many
                        profiles that we have on our site, and then contact anyone that you like the look of. That is all
                        there is
        ...
        <script
            src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key=AIzaSyDkeNNsdK4dt7Zr-q5sScHnp8ZE5FrhAmI">
        </script>
