                        ...
                        <div class="col-lg-6 py-5">
                            <div class="row hero-content">
                                ...
                                <div class="fs-6 text-secondary hero-description">
                                    ...
                                    <p>Looking to find friends with benefits? luckymate is all about that. We make it
                                        easier. All members on the site are looking to get laid. </p>
                                    <p>Stop stressing yourself with other dating sites if all you need is some steamy
                                        sessions. </p>
                ...
                <div class="row">
                    <div class="why-us col-lg-8 mx-auto py-5">
                        ...
                        <div class="row why-us-top text-center m-3 p-3">
                            ...
                            <p>Our singles site might not be all about romance or love, but if you are looking for an
                                encounter that is hot and exciting and that you will never forget then our site is exactly
                                what you have been looking for. Your search for the ideal online dating service just ended
                                the moment you set foot on our site.</p>
                            <div class="main-btn-box row px-5">
                                <a href="/signup" role="button"
